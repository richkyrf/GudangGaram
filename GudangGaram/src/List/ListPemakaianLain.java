 ...
 * @author richky
 */
public class ListPemakaianLain extends javax.swing.JFrame {

    /**
     * Creates new form ListPenerimaan
     */
    public ListPemakaianLain() {
        initComponents();
        setVisible(true);
        setTitle("List Pemakaian Barang Lain");
    ...
    private void formWindowClosed(java.awt.event.WindowEvent evt) {//GEN-FIRST:event_formWindowClosed
        GlobalVar.Var.listPemakaianLain = null;
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ListPemakaianLain.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ListPemakaianLain().setVisible(true);
            }
        });
    }
    ...
    void hapus() {
        if (jcomCari1.getSelectedRow() < 0) {
            ...
            Boolean berhasil = delete.Hapus("ID " + jcomCari1.GetIDTable(), "DELETE FROM `tbpemakaianlain` WHERE `IdPemakaianLain` = " + jcomCari1.GetIDTable(), "Pemakaian Lain", this);
            if (berhasil) {
                refreshAll();
            }
        }
    ...
    void ubah() {
        if (jcomCari1.getSelectedRow() < 0) {
            ...
            if (GlobalVar.Var.ubahPemakaianLain == null) {
                GlobalVar.Var.ubahPemakaianLain = new PemakaianLain(jcomCari1.GetIDTable());
            } else {
