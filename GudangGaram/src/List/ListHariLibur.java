 ...
 * @author Martono
 */
public class ListHariLibur extends javax.swing.JFrame {
    ...
    private void formWindowClosed(java.awt.event.WindowEvent evt) {//GEN-FIRST:event_formWindowClosed
        GlobalVar.Var.listHariLibur = null;
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ListHariLibur.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
    ...
    void tambah() {
        if (GlobalVar.Var.tambahHariLibur == null) {
            GlobalVar.Var.tambahHariLibur = new MasterHariLibur("0");
        } else {
            GlobalVar.Var.tambahHariLibur.setState(NORMAL);
            GlobalVar.Var.tambahHariLibur.toFront();
        }
    }
    ...
    void ubah() {
        if (JComCari.getSelectedRow() < 0) {
            ...
            if (GlobalVar.Var.ubahHariLibur == null) {
                GlobalVar.Var.ubahHariLibur = new MasterHariLibur(JComCari.GetIDTable());
            } else {
                GlobalVar.Var.ubahHariLibur.setState(NORMAL);
                GlobalVar.Var.ubahHariLibur.toFront();
            }
        }
    }
