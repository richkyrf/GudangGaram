...
public class ListKaryawan extends javax.swing.JFrame {
    ...
    private void formWindowClosed(java.awt.event.WindowEvent evt) {//GEN-FIRST:event_formWindowClosed
        GlobalVar.Var.listKaryawan = null;
    ...
    void hapus() {
        if (jcomCari1.getSelectedRow() < 0) {
            ...
            Boolean berhasil = delete.Hapus("ID " + jcomCari1.GetIDTable(), "DELETE FROM `tbmkaryawan` WHERE `IdKaryawan` = " + jcomCari1.GetIDTable(), "Karyawan", this);
            if (berhasil) {
                refreshAll();
            }
        }
    ...
    void ubah() {
        if (jcomCari1.getSelectedRow() < 0) {
            ...
            if (GlobalVar.Var.ubahKaryawan == null) {
                GlobalVar.Var.ubahKaryawan = new MasterKaryawan(jcomCari1.GetIDTable());
            } else {
                GlobalVar.Var.ubahKaryawan.setState(NORMAL);
                GlobalVar.Var.ubahKaryawan.toFront();
            }
        }
    }
